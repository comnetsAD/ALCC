...
def RunCopa():
	...
	command = "mm-delay 10 mm-link --meter-uplink --meter-uplink-delay ./channelTraces/" + str(args.trace) + " ./channelTraces/"  + str(args.trace)
...
def RunAlccCopa():
	...
	command = "mm-delay 10 mm-link --meter-downlink --meter-downlink-delay ./channelTraces/" + str(args.trace) + " ./channelTraces/"  + str(args.trace)
...
def RunAlccVerus():
	...
	os.system("sudo mv /tmp/2020-*/* "+args.dir+str(args.name)+"/")
	os.system("sudo rm -r /tmp/2020-*")
