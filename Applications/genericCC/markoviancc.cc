...
void MarkovianCC::onACK(int ack, 
  ...
  double relativeTime = (currentTime.tv_sec - startTime.tv_sec) + (currentTime.tv_usec - startTime.tv_usec) / 1000000.0;

  cout << "--RTT--, " << relativeTime << ", " << cur_time - sent_time << endl << flush;
